...
void main() {
  ...
  group("Comment Documentation", () {
    ...
    test("Description contains note if has default value", () {
      // exists, and not exists
    });

    test("Description contains note if has nullable/not nullable", () {
      // exists, and not exists
    });

    test("Description contains multi-column unique note if exists", () {
      // exists, and not exists
    });
  });
}
