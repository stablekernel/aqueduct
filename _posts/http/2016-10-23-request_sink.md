...
Only `setupRouter` is required, but it is extremely common to provide a new constructor and implement `RequestSink.initializeApplication`. It is rare to use `willOpen` and rarer still to use `didOpen`.
