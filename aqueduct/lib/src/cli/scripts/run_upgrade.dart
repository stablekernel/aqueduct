...
class RunUpgradeExecutable extends Executable<Map<String, dynamic>> {
  ...
  Future<Map<String, dynamic>> execute() async {
    ...
    if (dbInfo != null) {
      PersistentStoreConnection connection = PersistentStoreConnection(
          dbInfo.flavor,
          dbInfo.username,
          dbInfo.password,
          dbInfo.host,
      ...
      connection.setLogger(Level.ALL, log);
      store = connection.persistentStore;
    }
    ...
    try {
      ...
      if (e.event == QueryExceptionEvent.transport) {
        final databaseUrl =
            "${dbInfo.flavor}://${dbInfo.username}:${dbInfo.password}@${dbInfo.host}:${dbInfo.port}/${dbInfo.databaseName}";
        return {
          "error":
  ...
  static List<String> get imports => [
        ...
        "package:sqljocky5/sqljocky.dart",
