...
import 'package:aqueduct/src/db/shared/instance_wrapper.dart';
...
abstract class RowInstantiator<RT extends Iterable> {
  ...
  List<U> instancesForRows<U extends ManagedObject>(List<RT> rows) {
    try {
      return rows
