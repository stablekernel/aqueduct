...
>>>>>>> Stashed changes
  ...
  void didFinishPackageGeneration(BuildContext context) {
    if (context.forTests) {
      ...
      pubspecContents["dev_dependencies"]["aqueduct_test"]["path"] =
          "packages/aqueduct_test";
      pubspecContents["dependency_overrides"]["aqueduct"] =
          pubspecContents["dependencies"]["aqueduct"];
