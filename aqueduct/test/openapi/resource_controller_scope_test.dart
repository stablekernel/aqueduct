...
void main() {
  ...
  test(
    ...
    expect(
        doc!.paths!["/level1-authorizer"]!.operations!["post"]!.security!
            .length,
        1);
    expect(
  ...
  test("If authorizer has less scope than method scope, method scope is used",
      () {
    expect(
        doc!.paths!["/level1-subscope-authorizer"]!.operations!["get"]!
            .security!.length,
        1);
    expect(
        doc!.paths!["/level1-subscope-authorizer"]!.operations!["get"]!
    ...
    expect(
        doc!.paths!["/level1-subscope-authorizer"]!.operations!["put"]!
            .security!.length,
        1);
    expect(
        doc!.paths!["/level1-subscope-authorizer"]!.operations!["put"]!
