...
void main() {
  ...
  test("A thrown rollback rolls back transaction and returns rollback reason",
      () async {
  ...
  test(
      "Query on origional context within transaction block times out and cancels transaction",
      () async {
    try {
      await context.transaction((t) async {
        await Query.insertObject(t, Model()..name = "1");
