...
abstract class QueryAdapter {
  ...
  ///
  /// To allow clients to perform commands that just can't be accomplished in inquirer.
  ...
  ///
  /// The primary action mechanism of inquirer, this method will execute this Query
