...
class _DataModelBuilder {
  _DataModelBuilder(ManagedDataModel dataModel, List<Type> instanceTypes) {
    instanceTypes.forEach((type) {
      var entity = new ManagedEntity(
          dataModel, reflectClass(type), backingMirrorForType(type));
    ...
    entities.forEach((_, entity) {
      ...
      if (entity.primaryKey == null) {
        throw new ManagedDataModelException(
            "No primary key for entity ${MirrorSystem.getName(entity.persistentType.simpleName)}");
      }
    });
  ...
  String tableNameForEntity(ManagedEntity entity) {
    ...
    if (entity.persistentType.staticMembers[tableNameSymbol] != null) {
      return entity.persistentType.invoke(tableNameSymbol, []).reflectee;
    }
