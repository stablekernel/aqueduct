...
class SchemaColumn {
  ...
  SchemaColumn.relationship(this.name, ManagedPropertyType t, {this.isNullable: true, this.isUnique: false, this.relatedTableName, this.relatedColumnName, ManagedRelationshipDeleteRule rule: ManagedRelationshipDeleteRule.nullify}) {
    isIndexed = true;
    _type = typeStringForType(t);
  ...
  static String typeStringForType(ManagedPropertyType type) {
    switch (type) {
      case ManagedPropertyType.integer: return "integer";
      case ManagedPropertyType.doublePrecision: return "double";
      case ManagedPropertyType.bigInteger: return "bigInteger";
      case ManagedPropertyType.boolean: return "boolean";
      case ManagedPropertyType.datetime: return "datetime";
  ...
  static ManagedPropertyType typeFromTypeString(String type) {
    switch (type) {
      case "integer": return ManagedPropertyType.integer;
      case "double": return ManagedPropertyType.doublePrecision;
      case "bigInteger": return ManagedPropertyType.bigInteger;
      case "boolean": return ManagedPropertyType.boolean;
      case "datetime": return ManagedPropertyType.datetime;
      case "string": return ManagedPropertyType.string;
    }
    return null;
  }
  ...
  static String deleteRuleStringForDeleteRule(ManagedRelationshipDeleteRule rule) {
    switch (rule) {
      case ManagedRelationshipDeleteRule.cascade: return "cascade";
      case ManagedRelationshipDeleteRule.nullify: return "nullify";
      case ManagedRelationshipDeleteRule.restrict: return "restrict";
      case ManagedRelationshipDeleteRule.setDefault: return "default";
    }
    return null;
  }
  ...
  static ManagedRelationshipDeleteRule deleteRuleForDeleteRuleString(String rule) {
    switch (rule) {
      case "cascade": return ManagedRelationshipDeleteRule.cascade;
      case "nullify": return ManagedRelationshipDeleteRule.nullify;
      case "restrict": return ManagedRelationshipDeleteRule.restrict;
      case "default": return ManagedRelationshipDeleteRule.setDefault;
    }
    return null;
  }
