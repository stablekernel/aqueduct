...
class ManagedDataModelException implements Exception {
  ...
  factory ManagedDataModelException.invalidType(ManagedEntity entity,
      Symbol property) {
    return new ManagedDataModelException(
        "Property '${_getName(property)}' on "
  ...
  factory ManagedDataModelException.invalidMetadata(ManagedEntity entity,
  ...
  factory ManagedDataModelException.missingInverse(ManagedEntity entity,
      Symbol property, ManagedEntity destinationEntity,
  ...
  factory ManagedDataModelException.incompatibleDeleteRule(ManagedEntity entity,
      Symbol property) {
    return new ManagedDataModelException(
        "Relationship '${_getName(property)}' on "
            "'${_getPersistentClassName(entity)}' "
  ...
  factory ManagedDataModelException.dualMetadata(ManagedEntity entity,
      Symbol property, ManagedEntity destinationEntity,
  ...
  factory ManagedDataModelException.multipleDestinationEntities(
      ManagedEntity entity, Symbol property, List<ManagedEntity> possibleEntities) {
    var destType = entity.persistentType.instanceMembers[property].returnType.simpleName;
    return new ManagedDataModelException(
        "Relationship '${_getName(property)}' on "
