...
ManagedPropertyDescription _propertyForName(ManagedEntity entity, String propertyName) {
...
List<PersistentColumnMapping> mappingElementsForList(List<String> keys, ManagedEntity entity) {
...
List<PersistentColumnMapping> mappingElementsForMap(Map<String, dynamic> valueMap, ManagedEntity entity) {
...
List<PersistentJoinMapping> joinElementsFromQueryMatchable(QueryMatchableExtension matcherBackedObject,
