...
/// Binds elements of an HTTP request to a [HTTPController]'s responder method arguments and properties.
///
...
class Bind {
  ...
  ///
  /// If a declaration with this metadata is a positional argument in a responder method, it is required for that method. A 400 Bad Request
  /// will be sent and the responder method will not be invoked if the request does not contain the query key.
  ///
  /// If a declaration with this metadata is an optional argument in a responder method, it is optional for that method. The value of
  ...
  ///
  /// Note that multiple responder methods can have the same [Bind.method] metadata as long as each method
  /// has different [Bind.path] arguments. A responder method is invoked if both [Bind.method] and its [Bind.path] arguments
  ...
  ///
  /// If a declaration with this metadata is a positional argument in a responder method, it is required for that method. A 400 Bad Request
  /// will be sent and the responder method will not be invoked if the request does not contain the header.
  ///
  /// If a declaration with this metadata is an optional argument in a responder method, it is optional for that method. The value of
  /// the bound property will be null if it was not present in the request.
  ///
